    ...
    function updateMotionValuesFromProps(element, next, prev) {
        ...
        for (const key in next) {
            ...
            if (isMotionValue(nextValue)) {
                 ...
                 */
                {
                    warnOnce(nextValue.version === "10.11.4", `Attempting to mix Framer Motion versions ${nextValue.version} with 10.11.4 may not work as expected.`);
                }
            }
